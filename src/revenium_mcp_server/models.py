...
class Tier(BaseReveniumModel):
    ...
    def validate_pricing_fields(self) -> "Tier":
...
class Plan(BaseReveniumModel):
    ...
    @classmethod
    def validate_tiers(cls, v: List[Tier]) -> List[Tier]:
        if not v or len(v) == 0:
    ...
    @classmethod
    def validate_period_count(cls, v: int) -> int:
    ...
    @classmethod
    def validate_trial_period_count(cls, v: Optional[int]) -> Optional[int]:
        if v is not None and v <= 0:
...
class Product(BaseReveniumModel):
    ...
    @classmethod
    def validate_notification_addresses(cls, v: List[str]) -> List[str]:
        import re
...
class AIAnomalyRequest(BaseReveniumModel):
    ...
    @classmethod
    def validate_threshold(cls, v: Union[int, float]) -> Union[int, float]:
        if v is None:
    ...
    @classmethod
    def validate_slack_configurations(cls, v: List[str]) -> List[str]:
    ...
    @classmethod
    def validate_webhook_configurations(cls, v: List[str]) -> List[str]:
        if not isinstance(v, list):
    ...
    @classmethod
    def validate_filters(cls, v: List[Any]) -> List[Any]:
        if not isinstance(v, list):
...
class AIAlert(BaseReveniumModel):
    ...
    @classmethod
    def validate_status_transitions(cls, v: "AlertStatus") -> "AlertStatus":
        if not v:
    ...
    @classmethod
    def validate_severity(cls, v: "AlertSeverity") -> "AlertSeverity":
        if not v:
