...
from revenium_mcp_server.common.error_handling import ToolError
...
class TestSubscriptionUCMIntegration:
    ...
    async def test_ucm_capabilities_vs_fallback(self, tool_with_ucm, tool_without_ucm):
        ...
        # Without UCM, get_capabilities raises ToolError
        with pytest.raises(ToolError, match="no UCM integration"):
            await tool_without_ucm.validator.get_capabilities()

        # Verify specific subscription capabilities from UCM
